...
var modPageFn = function (Page) {
    return function (props) { return React.createElement(Page, __assign({}, props)); };
};
function render(options) {
    return __awaiter(this, void 0, void 0, function () {
        var req, res, routes, assets, Document, customRenderer, _a, scrollToTop, rest, Doc, context, renderPage, autoScrollRef, _b, match, initialData, _c, redirectTo, statusCode, reactRouterMatch, afterData, data, _d, html, docProps, doc;
        var _this = this;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    req = options.req, res = options.res, routes = options.routes, assets = options.assets, Document = options.document, customRenderer = options.customRenderer, _a = options.scrollToTop, scrollToTop = _a === void 0 ? true : _a, rest = __rest(options, ["req", "res", "routes", "assets", "document", "customRenderer", "scrollToTop"]);
                    Doc = Document || Document_1.Document;
                    context = {};
                    renderPage = function (fn) {
                        if (fn === void 0) { fn = modPageFn; }
                        return __awaiter(_this, void 0, void 0, function () {
                            var defaultRenderer, renderer, asyncOrSyncRender, renderedContent, _a, helmet, statusCode, redirectTo;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        asyncOrSyncRender = renderer(React.createElement(react_router_dom_1.StaticRouter, { location: req.url, context: context }, fn(After_1.After)({ routes: utils.getAllRoutes(routes), data: data })));
                ...
                case 1:
                    _b = _e.sent(), match = _b.match, initialData = _b.data;
                    if (initialData) {
                    ...
                    reactRouterMatch = react_router_dom_1.matchPath(req.url, match);
                    afterData = {
                    ...
                    return [4 /*yield*/, Doc.getInitialProps(__assign({ req: req,
                            ...
                            data: data, helmet: react_helmet_1.default.renderStatic(), match: reactRouterMatch, scrollToTop: autoScrollRef }, rest))];
                case 2:
                    _d = _e.sent(), html = _d.html, docProps = __rest(_d, ["html"]);
                    doc = ReactDOMServer.renderToStaticMarkup(React.createElement(Document_1.__AfterContext.Provider, { value: __assign({ assets: assets, data: data }, rest, docProps, { html: html }) },
