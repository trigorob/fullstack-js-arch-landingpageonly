...
export declare type InitialData = Promise<any>[];
...
export interface AsyncRouteComponent<Props = {}> extends AsyncComponent, React.Component<DocumentProps & Props, AsyncRouteComponentState> {
}
export declare type AsyncRouteComponentType<Props> = (React.ComponentClass<Props> & AsyncComponent) | (React.StatelessComponent<Props> & AsyncComponent);
export declare type AsyncRouteableComponent<Props = any> = AsyncRouteComponentType<RouteComponentProps<Props>> | React.ComponentType<RouteComponentProps<Props>> | React.ComponentType<Props>;
